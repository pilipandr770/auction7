...
class AuctionParticipant(db.Model):
    ...
    entry_payment_intent_id = db.Column(db.String(64), nullable=True)  # Stripe PI входу (ескроу)
    entry_amount = db.Column(db.Float, default=0.0)  # Сума входу (для розрахунку виплати продавцю)
