...
def register_error_handlers(app):
    ...
    def not_found_error(error):
        ...
        if lang == 'en':
            return render_template('errors/404_en.html'), 404
        elif lang == 'de':
            return render_template('errors/404_de.html'), 404
    ...
    def internal_error(error):
        lang = session.get('lang', 'ua')
        if lang == 'en':
            return render_template('errors/500_en.html'), 500
        elif lang == 'de':
            return render_template('errors/500_de.html'), 500
    ...
    def handle_exception(e):
        lang = session.get('lang', 'ua')
        if lang == 'en':
            return render_template('errors/generic_en.html', error=e), 500
        elif lang == 'de':
            return render_template('errors/generic_de.html', error=e), 500
